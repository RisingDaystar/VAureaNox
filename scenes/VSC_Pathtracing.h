...
namespace vscndef {
	...
	void init_pathtracing_scene(vnx::VScene& scn) {
		...
		diffuse->kr = vec3vf{0.5f,0.5f,0.65f};
		...
		mirror->kr = vec3vf{1.0f,1.0f,1.0f};
